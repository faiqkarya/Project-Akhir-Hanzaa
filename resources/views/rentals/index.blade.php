        ...
        <x-splade-table :for="$rentals">
            <x-slot:empty-state>
                ...
                <div class="flex gap-2">
                    ...
                    <x-splade-form action="{{ route('rentals.destroy', $rentals->id) }}" confirm="Delete Data" confirm-text="Are you sure you want to delete your post data?" confirm-button="Yes, delete everything!" cancel-button="No, I want to stay!" method="delete">
