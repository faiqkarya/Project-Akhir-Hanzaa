        ...
        <x-splade-table :for="$returnings">
            ...
            <x-slot:empty-state>
                ...
                <div class="flex gap-2">
                    ...
                    <x-splade-form action="{{ route('returnings.destroy', $returnings->id) }}" confirm="Delete Data" confirm-text="Are you sure you want to delete your post data?" confirm-button="Yes, delete everything!" cancel-button="No, I want to stay!" method="delete">
