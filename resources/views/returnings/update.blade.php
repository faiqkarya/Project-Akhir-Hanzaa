<x-splade-modal>
    ...
    <x-panel>
        <x-splade-form :default="['tanggal_dikembalikan' => $returning->tanggal_dikembalikan]" :action="route('returnings.update', $returning->id)" class="flex flex-col gap-4" method="put">
            <div class="gap-4">
                {{-- form input --}}
                <div class="flex flex-col gap-4">
                    
                    <x-splade-input name="tanggal_dikembalikan" type="date" label="Tanggal Penyewaan" />
