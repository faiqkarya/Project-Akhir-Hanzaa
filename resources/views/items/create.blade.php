<x-splade-modal max-width="6xl">
    <h1 class="text-lg text-gray-700 text-center font-semibold">Tambah Data Barang</h1>
    <x-panel>
        <x-splade-form action="/items" enctype='multipart/form-data'>
            <div class="flex gap-4">
                {{-- form input --}}
                <div class="w-1/2 flex flex-col gap-4">
                    <!-- <x-splade-input name="category_id" type="text" label="Category" placeholder="Input Category" /> -->
